...
public class FFV1 extends Shutter {
		...
		Thread thread = new Thread(new Runnable(){			
			...
			public void run() {
	            ...
	            try {
					...
					String sortieFichier =  sortie.replace("\\", "/") + "/" + fichier.replace(extension, nomExtension + ".mkv"); 
					...
					String cmd =  frameRate + filterComplex + " -c:v ffv1 -level 3 " + forceField + timecode + flags + " -y ";
