			...
			public void run() {
				...
				for (int i = 0 ; i < liste.getSize() ; i++)
				{
		           ...
		           //SCANNING
					...
					{						
						FFMPEG.toFFPLAY(loop + FFMPEG.inPoint + sequence + concat + " -guess_layout_max 0 -i " + '"' + file.toString() + '"' + logo + subtitles + FFMPEG.postInPoint + FFMPEG.outPoint + cmd + " -f mxf pipe:play |");
						break;
					}
