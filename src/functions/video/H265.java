...
public class H265 extends Shutter {
	...
	protected static String setBitrate() {
        if (lblVBR.getText().equals("CQ"))
        {
        	...
        	else
        	{
        		String gpu = "";
    			if (caseAccel.isSelected() && comboAccel.getSelectedItem().equals("Nvidia NVENC"))
    				gpu = " -rc vbr_hq -cq " + debitVideo.getSelectedItem().toString();
    				...
    				gpu = " -rc cqp -qp_i " + debitVideo.getSelectedItem().toString() + " -qp_p " + debitVideo.getSelectedItem().toString() + " -qp_b " + debitVideo.getSelectedItem().toString();        			
	...
	protected static String setFlags() { 
		...
		String flags = " -tag:v hvc1";
		
		flags += " -sws_flags " + Settings.comboScale.getSelectedItem().toString();
