...
public class FilesCellRenderer extends JLabel implements ListCellRenderer {
 ...
 public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected,
	    ...
	    switch (extension) {
	        ...
	        case "exr": case "tga":
	            setIcon(new FlatSVGIcon("contents/image.svg", iconSize, iconSize));
	            break;
	        ...
	        case "mxf": case "f4v": case "asf":
	            setIcon(new FlatSVGIcon("contents/video.svg", iconSize, iconSize));
	            break;
	        ...
	        case "ac3": case "dts": case "amr": case "au":
	            setIcon(new FlatSVGIcon("contents/audio.svg", iconSize, iconSize));
	            break;

	        default:
	            setIcon(new FlatSVGIcon("contents/file.svg", iconSize, iconSize));
	            break;
	    }
