...
public class Shutter {
	...
	protected static String audioValues[] = new String[] { "1536", "1344", "1152", "960", "768", "640", "512", "448",
			"384", "320", "256", "192", "160", "128", "96", "64", "32" };
		...
		if (Settings.btnLoadPreset.isSelected() && Settings.comboLoadPreset.getItemCount() > 0) {
			Thread t = new Thread(new Runnable() {
				...
				public void run() {
					...
					Utils.loadSettings(
							new File(Functions.functionsFolder + "/" + Settings.comboLoadPreset.getSelectedItem()));
				}
	...
	private void grpSetAudio() {
		...
		caseChangeAudioCodec.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (caseChangeAudioCodec.isSelected()) {
					...
					if (language.getProperty("functionMerge")
							.equals(comboFonctions.getSelectedItem().toString()) == false) {
		...
		comboAudioCodec.setModel(new DefaultComboBoxModel<String>(
				new String[] { "PCM 32Float", "PCM 32Bits", "PCM 24Bits", "PCM 16Bits", "AAC", "MP3", "AC3", "Opus",
						"Vorbis", "Dolby Digital Plus", language.getProperty("noAudio") }));
		...
		caseNormalizeAudio = new JCheckBox(
				language.getProperty("functionNormalization") + language.getProperty("colon"));
		caseNormalizeAudio.setName("caseNormalizeAudio");
		caseNormalizeAudio.setEnabled(false);
		caseNormalizeAudio.setFont(new Font(mainFont, Font.PLAIN, 12));
		caseNormalizeAudio.setBounds(7, caseChangeAudioCodec.getY() + caseChangeAudioCodec.getHeight(),
				caseNormalizeAudio.getPreferredSize().width, 23);
	...
	private void grpAudio() {
		...
		lblMix.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
		...
		lblSplit.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
	...
	private void grpOverlay() {
		...
		lblTcBackground.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
		...
		lblTimecode.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
	...
	private void grpSubtitles() {
		...
		caseAddSubtitles.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (caseAddSubtitles.isSelected() && VideoPlayer.videoPath != null) {
					if (Shutter.comboFonctions.getSelectedItem().toString()
							.equals(Shutter.language.getProperty("functionSubtitles"))) {
						if (System.getProperty("os.name").contains("Windows"))
							...
							Thread copySRT = new Thread(new Runnable() {
								...
								public void run() {
									...
									try {
										...
										FFMPEG.run(" -i " + '"' + fileIn + '"' + " -i " + '"' + subtitlesFilePath + '"'
												+ cmd + '"' + fileOut + '"');
										...
										if (Shutter.caseOpenFolderAtEnd1.isSelected() && Shutter.cancelled == false
											...
											} else // Windows
											{
												try {
													Runtime.getRuntime()
															.exec("explorer.exe /select," + fileOut.toString());
												} catch (IOException e1) {
												}
											}
										}
						...
						FileDialog dialog = new FileDialog(frame, Shutter.language.getProperty("chooseSubtitles"),
								FileDialog.LOAD);
						...
						if (dialog.getFile() != null) {
							...
							if (input.equals(".srt") || input.equals(".vtt") || input.equals(".ssa")
									|| input.equals(".ass") || input.equals(".scc")) {
								if (System.getProperty("os.name").contains("Windows")) {
								...
								if (input.equals(".srt") || input.equals(".vtt")) {
									...
									if (autoBurn == false && autoEmbed == false) {
										...
										if (Shutter.comboFonctions.getSelectedItem().toString()
												...
												|| Shutter.comboFonctions.getSelectedItem().toString()
														.equals(Shutter.language.getProperty("functionCut")))
											sub = 1;
										...
										if (Shutter.comboFilter.getSelectedItem().toString().equals(".mxf") == false
												...
												&& Shutter.comboFonctions.getSelectedItem().toString()
														.equals(Shutter.language.getProperty("functionRewrap")) == false
												&& Shutter.comboFonctions.getSelectedItem().toString()
														.equals(Shutter.language.getProperty("functionCut")) == false) {
									...
									if (sub == 0) // Burn
									{
										...
										if (input.equals(".vtt")) {
											subtitlesFilePath = new File(
													Shutter.subtitlesFile.toString().replace(".vtt", ".srt"));

											FFMPEG.run(" -i " + '"' + dialog.getDirectory()
													+ dialog.getFile().toString() + '"' + " -y " + '"'
													+ subtitlesFilePath.toString().replace(".srt", "_vtt.srt") + '"');
											...
											Shutter.subtitlesFile = new File(
													subtitlesFilePath.toString().replace(".srt", "_vtt.srt"));
										} else
											subtitlesFilePath = new File(
													dialog.getDirectory() + dialog.getFile().toString());
									...
									VideoPlayer.lblSpeed.setBounds(
											VideoPlayer.sliderSpeed.getX()
													- VideoPlayer.lblSpeed.getPreferredSize().width - 2,
		...
		lblSubsBackground.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
	...
	private void grpTransitions() {
		...
		lblFadeInColor.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
		...
		lblFadeOutColor.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
	...
	private void grpAdvanced() {
		...
		lblTFF.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
		...
		lblOPATOM.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
		...
		lblNiveaux.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
	...
	private void grpBitrate() {
		...
		lblFile.setFont(new Font(mainFont, Font.PLAIN, 12));
		...
		lblH264.setBounds(lblFile.getX() + lblFile.getWidth() + 2, lblFile.getY() - 1,
				302 - (lblFile.getX() + lblFile.getWidth()), 16);
		grpBitrate.add(lblH264);

		lblBitrateTimecode = new JLabel(language.getProperty("lblBitrateTimecode"));
		lblBitrateTimecode.setFont(new Font(mainFont, Font.PLAIN, 12));
		lblBitrateTimecode.setBounds(lblFile.getX(), lblFile.getY() + lblFile.getHeight() + 9,
				lblBitrateTimecode.getPreferredSize().width, 16);
		...
		textH.setFont(new Font(mainFont, Font.PLAIN, 13));
		textH.setColumns(10);
		...
		textM.setFont(new Font(mainFont, Font.PLAIN, 13));
		textM.setColumns(10);
		...
		textS.setFont(new Font(mainFont, Font.PLAIN, 13));
		textS.setColumns(10);
		...
		textF.setFont(new Font(mainFont, Font.PLAIN, 13));
		textF.setColumns(10);
		...
		lblVideoBitrate.setBounds(lblBitrateTimecode.getX(),
				lblBitrateTimecode.getY() + lblBitrateTimecode.getHeight() + 11, 80, 16);
		...
		lblMaximumBitrate.setBounds(lblBitrateTimecode.getX(),
		...
		lblAudioBitrate.setBounds(lblBitrateTimecode.getX(),
		...
		lblSize.setBounds(lblBitrateTimecode.getX(), lblAudioBitrate.getY() + lblAudioBitrate.getHeight() + 11,
				lblSize.getPreferredSize().width, 16);
		...
		lblVBR.setBorder(new FlatLineBorder(new Insets(0, 0, 0, 0), Utils.c30, 1, 10));
			...
			public void mouseReleased(MouseEvent arg0) {
				...
				if (btnReset.isEnabled()) {
					...
					if (language.getProperty("functionRewrap").equals(comboFonctions.getSelectedItem().toString())
							...
							|| language.getProperty("functionNormalization")
									.equals(comboFonctions.getSelectedItem().toString())) {
						comboAudioCodec.setModel(new DefaultComboBoxModel<String>(new String[] { "PCM 32Float",
								"PCM 32Bits", "PCM 24Bits", "PCM 16Bits", "AAC", "MP3", "AC3", "Opus", "Vorbis",
								"Dolby Digital Plus", language.getProperty("noAudio") }));
						comboAudioCodec.setSelectedIndex(3);
						caseNormalizeAudio.setEnabled(false);
						caseNormalizeAudio.setSelected(false);
						comboNormalizeAudio.setEnabled(false);
						...
						comboAudioCodec.setModel(new DefaultComboBoxModel<String>(
								new String[] { "PCM 16Bits", "PCM 24Bits", "PCM 32Bits",
										language.getProperty("codecCopy"), language.getProperty("noAudio") }));
						comboAudioCodec.setSelectedIndex(0);
						debitAudio.setModel(comboAudioBitrate.getModel());
						debitAudio.setSelectedIndex(0);
						caseNormalizeAudio.setEnabled(true);
						...
						comboAudioCodec
								.setModel(new DefaultComboBoxModel<String>(new String[] { "Opus", "AAC", "Vorbis",
										"FLAC", language.getProperty("codecCopy"), language.getProperty("noAudio") }));
						comboAudioCodec.setSelectedIndex(0);
						debitAudio.setModel(comboAudioBitrate.getModel());
						debitAudio.setSelectedIndex(11);
						caseNormalizeAudio.setEnabled(true);
	...
	private void StatusBar() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (System.getProperty("os.name").contains("Windows")
					...
					if (comboGPUDecoding.getSelectedItem().equals("auto")) {
						comboGPUFilter.setModel(new DefaultComboBoxModel<String>(
								new String[] { "auto", language.getProperty("aucun") }));
						comboGPUFilter.setSelectedIndex(0);
						comboGPUFilter.setEnabled(true);
					} else if (comboGPUDecoding.getSelectedItem().equals("qsv")) {
						comboGPUFilter.setModel(new DefaultComboBoxModel<String>(
								new String[] { "qsv", language.getProperty("aucun") }));
						comboGPUFilter.setSelectedIndex(0);
						comboGPUFilter.setEnabled(true);
					} else if (comboGPUDecoding.getSelectedItem().equals("cuda")) {
						comboGPUFilter.setModel(new DefaultComboBoxModel<String>(
								new String[] { "cuda", language.getProperty("aucun") }));
						comboGPUFilter.setSelectedIndex(0);
						comboGPUFilter.setEnabled(true);
					} else if (comboGPUDecoding.getSelectedItem().equals("vulkan")) {
						comboGPUFilter.setModel(new DefaultComboBoxModel<String>(
								new String[] { "vulkan", language.getProperty("aucun") }));
						comboGPUFilter.setSelectedIndex(0);
						comboGPUFilter.setEnabled(true);
					} else {
						comboGPUFilter.setModel(
								new DefaultComboBoxModel<String>(new String[] { language.getProperty("aucun") }));
						comboGPUFilter.setSelectedIndex(0);
		...
		comboGPUFilter.setBounds(lblGpuFiltering.getX() + lblGpuFiltering.getWidth() + 6, comboGPUDecoding.getY(),
				comboGPUFilter.getPreferredSize().width, 16);
		...
		if ((System.getProperty("os.name").contains("Windows") || System.getProperty("os.name").contains("Mac"))
				&& comboGPUDecoding.getSelectedItem().equals(language.getProperty("aucun")) == false) {
	...
	public static void resizeAll(int width, int height) {
		...
		if (frame.getWidth() < 1320 && noSettings == false) {
			...
			} else if (Shutter.frame.getSize().width > 654 && FFPROBE.totalLength > 40
					&& Shutter.caseEnableSequence.isSelected() == false && VideoPlayer.isPiping == false) {
		...
		settingsScrollBar.setBounds(frame.getWidth() - settingsScrollBar.getWidth() - 2, topPanel.getHeight() - 4, 11,
				frame.getHeight() - topPanel.getHeight() - statusBar.getHeight() + 4);

		// For grpOverlay resizing
		if (windowDrag == false && (caseAddTimecode.isSelected() || caseShowTimecode.isSelected()
				|| caseAddText.isSelected() || caseShowFileName.isSelected())) {
			windowDrag = true;
			VideoPlayer.resizeAll();
			windowDrag = false;
					...
					if (changeGroupes == false) // permet d'attendre la fin de l'action
					{
						try {
							...
							if (language.getProperty("functionConform").equals(function)
								...
								comboNormalizeAudio.setLocation(
										caseNormalizeAudio.getX() + caseNormalizeAudio.getWidth() + 7,
										caseNormalizeAudio.getLocation().y + 3);
								if (action)
								...
								if ((comboAudioCodec.getItemCount() != 11
									...
									comboAudioCodec.setModel(
											new DefaultComboBoxModel<String>(new String[] { "PCM 32Float", "PCM 32Bits",
													"PCM 24Bits", "PCM 16Bits", "AAC", "MP3", "AC3", "Opus", "Vorbis",
													"Dolby Digital Plus", language.getProperty("noAudio") }));
									comboAudioCodec.setSelectedIndex(3);
									caseNormalizeAudio.setEnabled(false);
									caseNormalizeAudio.setSelected(false);
								...
								lblAudio1.setLocation(12,
										caseNormalizeAudio.getY() + caseNormalizeAudio.getHeight() + 2);
								...
								if (comboAudioCodec.getItemCount() != 5
									...
									if (lblAudioMapping.getItemCount() > 1) {
										lblAudioMapping
												.setModel(new DefaultComboBoxModel<String>(new String[] { "Multi" }));
									}
									lblAudioMapping.setSelectedItem("Multi");
									...
									comboAudioCodec.setModel(new DefaultComboBoxModel<String>(new String[] {
											...
											language.getProperty("noAudio") }));
									caseChangeAudioCodec.setSelected(true);
									comboAudioCodec.setEnabled(true);
									lbl48k.setEnabled(true);

									if ("XDCAM HD422".equals(function) || "XDCAM HD 35".equals(function)
											|| "AVC-Intra 100".equals(function) || ("XAVC").equals(function)) {
										comboAudioCodec.setSelectedIndex(1);
									} else {
										comboAudioCodec.setSelectedIndex(0);
									...
									Thread hwaccel = new Thread(new Runnable() {
										...
										public void run() {
											...
											if ("Apple ProRes".equals(comboFonctions.getSelectedItem().toString())
													...
													&& arch.equals("arm64")) {
												FFMPEG.hwaccel(
														"-f lavfi -i nullsrc -t 1 -c:v prores_videotoolbox -s 640x360 -f null -");
								...
								grpBitrate.setBounds(grpBitrate.getX(),
										grpResolution.getSize().height + grpResolution.getLocation().y + 6, 312, 208);
								lblMaximumBitrate.setVisible(true);
								maximumBitrate.setVisible(true);
								lblMaximumKbs.setVisible(true);
								lblAudioBitrate.setLocation(lblBitrateTimecode.getX(),
								...
								lblSize.setLocation(lblBitrateTimecode.getX(),
							...
							if (comboFonctions.getSelectedItem()
									.equals(Shutter.language.getProperty("functionSubtitles")) && action) {
								VideoPlayer.videoPath = null;
								VideoPlayer.setMedia();
							}
