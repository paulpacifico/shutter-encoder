...
public class Shutter {
	 ...
	 * Initialisation
	 */
	public static String actualVersion = "20.4";
	...
	private void grpChooseFiles() {
		...
		JScrollBar horizontalBar = scrollBar.getHorizontalScrollBar();
		horizontalBar.setBackground(Utils.c35);
	...
	private void grpImageSequence() {
		...
		sliderBlend.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent e) {
				...
				//Only visible when playing the video
				VideoPlayerCore.playerSetTime(VideoPlayerCore.playerCurrentFrame);
			}
	...
	private void grpFileInformation() {
		...
		grpFileInformation.addComponentListener(new ComponentAdapter() {
